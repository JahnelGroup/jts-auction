...
public class WebApiExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * @return
     */
    private ResponseEntity<ApiError> wrap(ResponseEntity resp, Exception ex, BindingResult bindingResult) {
        try{
            return converter.convert(resp, ex, bindingResult);
        }catch(Exception e){
    ...
    protected ResponseEntity handleAsyncRequestTimeoutException(AsyncRequestTimeoutException ex, HttpHeaders headers, HttpStatus status, WebRequest webRequest) {
        ResponseEntity resp = super.handleAsyncRequestTimeoutException(ex, headers, status, webRequest);
        return wrap(resp, ex, null);
    }
    ...
    protected ResponseEntity handleBindException(BindException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return wrap(resp, ex, ex.getBindingResult());
    }
